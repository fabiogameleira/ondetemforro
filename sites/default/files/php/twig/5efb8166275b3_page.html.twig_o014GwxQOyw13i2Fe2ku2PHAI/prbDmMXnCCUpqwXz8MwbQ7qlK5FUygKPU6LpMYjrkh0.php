...
class __TwigTemplate_9407900941e875b88de352f023e28a3c3970a8c25f5b96d12c876167e4fc9113 extends \Twig\Template
{
...
\t\t  ";
        ...
        // line 81
        echo "\t\t  
\t\t  <div class=\"navbar-header col-xs-6 col-md-2 ondetem\">
\t\t\t";
        // line 84
        echo "\t\t\t\t";
...
\t\t  <div class=\"navbar-right col-xs-6 col-md-2\">
\t\t\t";
        // line 97
        echo "   
\t\t\t\t";
...
($context["page"] ?? null), "sidebar_first", []) && $this->getAttribute(($context["page"] ?? null), "sidebar_second", []))) ? ("col-sm-6") : ("")), 1 => ((($this->getAttribute(        // line 148
($context["page"] ?? null), "sidebar_first", []) && twig_test_empty($this->getAttribute(($context["page"] ?? null), "sidebar_second", [])))) ? ("col-sm-9") : ("")), 2 => ((($this->getAttribute(        // line 149
($context["page"] ?? null), "sidebar_second", []) && twig_test_empty($this->getAttribute(($context["page"] ?? null), "sidebar_first", [])))) ? ("col-sm-9") : ("")), 3 => (((twig_test_empty($this->getAttribute(        // line 150
